...
//                .getElements().get(element.getElements().size() - 1); 
        XmlElement isStart = new XmlElement("if"); //$NON-NLS-1$  
        isStart.addAttribute(new Attribute("test", "limitClauseStart != null and limitClauseStart >= 0")); //$NON-NLS-1$ //$NON-NLS-2$  
