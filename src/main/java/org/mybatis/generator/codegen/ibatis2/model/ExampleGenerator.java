...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        //aded by yangqx start for page limit
     // add field, getter, setter for limitClauseStart clause
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(PrimitiveTypeWrapper.getIntegerInstance());
        field.setName("limitClauseStart"); //$NON-NLS-1$
        commentGenerator.addFieldComment(field, introspectedTable);
        topLevelClass.addField(field);

        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("setLimitClauseStart"); //$NON-NLS-1$
        method.addParameter(new Parameter(PrimitiveTypeWrapper
                .getIntegerInstance(), "limitClauseStart")); //$NON-NLS-1$
        method.addBodyLine("this.limitClauseStart = limitClauseStart;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        method.setName("getLimitClauseStart"); //$NON-NLS-1$
        method.addBodyLine("return limitClauseStart;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        
        // add field, getter, setter for limitClauseCount clause
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(PrimitiveTypeWrapper.getIntegerInstance());
        field.setName("limitClauseCount"); //$NON-NLS-1$
        commentGenerator.addFieldComment(field, introspectedTable);
        topLevelClass.addField(field);

        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("setLimitClauseCount"); //$NON-NLS-1$
        method.addParameter(new Parameter(PrimitiveTypeWrapper
                .getIntegerInstance(), "limitClauseCount")); //$NON-NLS-1$
        method.addBodyLine("this.limitClauseCount = limitClauseCount;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setReturnType(PrimitiveTypeWrapper.getIntegerInstance());
        method.setName("getLimitClauseCount"); //$NON-NLS-1$
        method.addBodyLine("return limitClauseCount;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        
        // add field, getter, setter for suffix clause
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(FullyQualifiedJavaType.getStringInstance());
        field.setName("suffix"); //$NON-NLS-1$
        ...
        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("setSuffix"); //$NON-NLS-1$
        method.addParameter(new Parameter(FullyQualifiedJavaType
                .getStringInstance(), "suffix")); //$NON-NLS-1$
        method.addBodyLine("this.suffix = suffix;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setReturnType(FullyQualifiedJavaType.getStringInstance());
        method.setName("getSuffix"); //$NON-NLS-1$
        method.addBodyLine("return suffix;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
